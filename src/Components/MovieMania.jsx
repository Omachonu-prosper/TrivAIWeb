...
const MovieMania = () => {
  return (
    <section className="mt-8 lg:mt-[100px] lg:w-[88%] container mx-auto flex font-nunito text-[#fefefe] mb-[100px]">
      <div className="flex flex-col items-center justify-center w-full text-white lg:h-[300px] h-[350px] border-2 custom-border rounded-xl relative overflow-hidden">
        <Image src={movieManiaImage} className="absolute z-0 scale-125 lg:scale-100" />
